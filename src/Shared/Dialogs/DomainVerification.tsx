                    ...
                    <Grid container>
                        ...
                        <Box className={clsx(classes.dFlex)} style={{ marginBlock: 15, alignContent: 'center', justifyContent: 'flex-start', gap: 15 }}>
                            <Box style={{ maxWidth: 200 }}>
                                <Typography title={t("campaigns.newsLetterEditor.fromEmail").replace('<b>', '').replace('</b>','')} className={clsx(classes.alignDir, classes.bold)}>{RenderHtml(t("campaigns.newsLetterEditor.fromEmail"))}</Typography>
                                <TextField
                                    inputMode="url"
                                    dir="ltr"
                            ...
                            <Box className='selectWrapper' style={{ maxWidth: 200 }}>
                                <Typography title={t("campaigns.newsLetterEditor.replyTo").replace('<b>', '').replace('</b>', '')} className={clsx(classes.alignDir, classes.bold)}>{RenderHtml(t("campaigns.newsLetterEditor.replyTo"))}</Typography>
                                <FormControl
