...
const App = ({ screenSize }) => {
  ...
  const { language, isRTL, windowSize, isClal, isDebtAccount, isAdmin, isLoader, userRoles, isOnlyWhatsAppChat, subUserName, subUserObject, email, companyName, isDrawerOpen } = useSelector(state => state.core)
