...
export const getSMSVirtualNumber = createAsyncThunk(
	...
	async (number, thunkAPI) => {
		try {
			const response = await PulseemReactInstance.get(
				`smsCampaign/GetAccountVirtualNumber/${number}`
			);
			return JSON.parse(response.data);
		} catch (error) {
			return thunkAPI.rejectWithValue({ error: error.message });
...
export const getCreditsforSMS = createAsyncThunk(
	'smsCampaign/GetCreditsForSms',
	async (count, thunkAPI) => {
		try {
			const response = await PulseemReactInstance.get(
				`smsCampaign/GetCreditsForSms/${count}`
			);
...
export const getSmsByID = createAsyncThunk(
	...
	async (id, thunkAPI) => {
		try {
			const response = await PulseemReactInstance.get(
				`smsCampaign/GetSmsCampaignById/${id}`
			);
			return JSON.parse(response.data);
		} catch (error) {
			return thunkAPI.rejectWithValue({ error: error.message });
...
export const exportArchiveSmsDirect = createAsyncThunk(
	'directReport/ExportArchiveSmsDirect',
	async (data, thunkAPI) => {
		try {
			const response = await PulseemReactInstance.post(
				`directReport/ExportArchiveSmsDirect`,
...
export const duplicteSms = createAsyncThunk(
	...
	async (id, thunkAPI) => {
		try {
			const response = await PulseemReactInstance.put(
				`smsCampaign/cloneSmsCampaign/${id}`
			);
			return response.data;
		} catch (error) {
			return thunkAPI.rejectWithValue({ error: error.message });
...
export const smsDelete = createAsyncThunk(
	...
	async (id, thunkAPI) => {
		try {
			const response = await PulseemReactInstance.post(
				`smsCampaign/deleteSmsCampaign/${id}`
			);
			return JSON.parse(response.data);
		} catch (error) {
			return thunkAPI.rejectWithValue({ error: error.message });
...
export const sendVerificationCode = createAsyncThunk(
	'authorization/newAuthorizeNumbers',
	async (data, thunkAPI) => {
		const { username = '', number = '' } = data || {};
		try {
			const response = await PulseemReactInstance.put(
				`authorization/newAuthorizeNumbers/${username}/${number}`
			);
			return JSON.parse(response.data);
		} catch (error) {
			return thunkAPI.rejectWithValue({ error: error.message });
...
export const verifyCode = createAsyncThunk(
	...
	async (data, thunkAPI) => {
		try {
			const response = await PulseemReactInstance.put(
				`authorization/newAuthorizeNumberInsertCode/${data.phoneNumber}/${data.optinCode}`
			);
			return JSON.parse(response.data);
		} catch (error) {
			return thunkAPI.rejectWithValue({ error: error.message });
...
export const getCampaignSumm = createAsyncThunk(
	...
	async (id, thunkAPI) => {
		try {
			const response = await PulseemReactInstance.get(
				`smsCampaign/GetCampaignSummary/${id}`
			);
			return JSON.parse(response.data);
		} catch (error) {
			return thunkAPI.rejectWithValue({ error: error.message });
...
export const saveSmsCampSettings = createAsyncThunk(
	'smsCampaign/SaveCampaignSettings',
	async (data, thunkAPI) => {
		try {
			const response = await PulseemReactInstance.post(
				`smsCampaign/SaveCampaignSettings`,
...
export const getCampaignSettings = createAsyncThunk(
	...
	async (campaignId, thunkAPI) => {
		try {
			const response = await PulseemReactInstance.get(
				`smsCampaign/GetCampaignSettings/${campaignId}`
			);
			return JSON.parse(response.data);
		} catch (error) {
			return thunkAPI.rejectWithValue({ error: error.message });
...
export const IsOTPPassed = createAsyncThunk(
	'smsCampaign/IsOTPPassed',
	async (fromNumber, thunkAPI) => {
		try {
			const response = await PulseemReactInstance.get(
				`smsCampaign/IsOTPPassed/${fromNumber}`
			);
			return JSON.parse(response.data);
		} catch (error) {
			return thunkAPI.rejectWithValue({ error: error.message });
...
export const smsSlice = createSlice({
	...
	extraReducers: (builder) => {
		...
		builder.addCase(
			getArchiveSMSDirectReport.fulfilled,
			(state, { payload }) => {
				state.directSmsReport = payload;
