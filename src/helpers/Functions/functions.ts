...
import { TYPE_PATH, TYPE_STATUS, TYPE_URL } from "../Types/common";
...
export const verifyGetUrl = (url: TYPE_URL = "") => {
...
export const emailStatusToString = (statusId: TYPE_STATUS = 0) => {
  if (statusId) {
...
export const smsStatusToString = (status: TYPE_STATUS = 0) => {
  if (status) {
...
export const smsStatusColor = (status: TYPE_STATUS = 0) => {
  switch (status.toString()) {
    default:
    case "-1":
    case "1": {
...
export const emailStatusColor = (status: TYPE_STATUS = 0) => {
  switch (status.toString()) {
    default:
    case "1": {
      return "#000";
