...
export const PlaceHolders = {
    ...
    RECAPTCHA_V3: "<script src=\"https://www.google.com/recaptcha/api.js\"></script><script>window.addEventListener('load', function() { grecaptcha.ready(function() { grecaptcha.execute('6LeJkBorAAAAAC1q2G6fGQqIr-GuqSEF3L91AsT9', {action: 'submit'}).then(function(token) { window.recaptchaToken = token; var hiddenInput = document.createElement('input'); hiddenInput.type = 'hidden'; hiddenInput.name = 'g-recaptcha-response'; hiddenInput.value = token; document.body.appendChild(hiddenInput); }); }); });</script>",
...
export const TIER_PLANS = [
    ...
    },
    {
        ...
        features: [
            ...
            'billing.tier.features.SubAccounts',
            'billing.tier.features.UserManagementPermissions',
    ...
    },
    {
        ...
        features: [
            ...
            'billing.tier.features.PopUpsUnlimited',
    ...
    },
    {
        ...
        features: [
            ...
            'billing.tier.features.VIPSupport',
            'billing.tier.features.PersonalTraining',
            'billing.tier.features.DedicatedAITeam',
            'billing.tier.features.BuildNewslettersAI'
        ],
        isPopular: false,
    },
];
