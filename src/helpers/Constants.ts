...
export const TierFeatures = {
  "EMAIL_BASIC": "tiers.featureNames.EMAIL_BASIC",
  "SMS_BASIC": "tiers.featureNames.SMS_BASIC",
  "WHATSAPP_BASIC": "tiers.featureNames.WHATSAPP_BASIC",
  "WEB_PUSH": "tiers.featureNames.WEB_PUSH",
  "BASIC_REPORTS": "tiers.featureNames.BASIC_REPORTS",
  "CHAT_EMAIL_SUPPORT": "tiers.featureNames.CHAT_EMAIL_SUPPORT",
  "NEWSLETTER_TEMPLATES": "tiers.featureNames.NEWSLETTER_TEMPLATES",
  "BASIC_PERSONALIZATION": "tiers.featureNames.BASIC_PERSONALIZATION",
  "SMS_CLICK_TRACKING": "tiers.featureNames.SMS_CLICK_TRACKING",
  "WHATSAPP_TEMPLATES": "tiers.featureNames.WHATSAPP_TEMPLATES",
  "LANDING_PAGE_EDITOR": "tiers.featureNames.LANDING_PAGE_EDITOR",
  "AUTOMATION_TEMPLATES": "tiers.featureNames.AUTOMATION_TEMPLATES",
  "BASIC_TRIGGERS": "tiers.featureNames.BASIC_TRIGGERS",
  "GROUP_MANAGEMENT": "tiers.featureNames.GROUP_MANAGEMENT",
  "DATE_TRIGGER": "tiers.featureNames.DATE_TRIGGER",
  "BASIC_AB_TESTING": "tiers.featureNames.BASIC_AB_TESTING",
  "WHATSAPP_MEDIA_ATTACHMENT": "tiers.featureNames.WHATSAPP_MEDIA_ATTACHMENT",
  "WHATSAPP_BUTTON_ATTACHMENT": "tiers.featureNames.WHATSAPP_BUTTON_ATTACHMENT",
  "WHATSAPP_CARD_MESSAGE": "tiers.featureNames.WHATSAPP_CARD_MESSAGE",
  "WHATSAPP_TEMPLATE_MANAGEMENT": "tiers.featureNames.WHATSAPP_TEMPLATE_MANAGEMENT",
  "WHATSAPP_CAMPAIGN_SEND": "tiers.featureNames.WHATSAPP_CAMPAIGN_SEND",
  "WHATSAPP_RESPONSE_REPORT": "tiers.featureNames.WHATSAPP_RESPONSE_REPORT",
  "WHATSAPP_REPORT": "tiers.featureNames.WHATSAPP_REPORT",
  "WHATSAPP_CHAT_INTERFACE": "tiers.featureNames.WHATSAPP_CHAT_INTERFACE",
  "SMS_RESPONSE_REPORT": "tiers.featureNames.SMS_RESPONSE_REPORT",
  "SMS_REPORT": "tiers.featureNames.SMS_REPORT",
  "SMS_BASIC_PERSONALIZATION": "tiers.featureNames.SMS_BASIC_PERSONALIZATION",
  "AUTOMATION_UNLIMITED": "tiers.featureNames.AUTOMATION_UNLIMITED",
  "LANDING_PAGES_UNLIMITED": "tiers.featureNames.LANDING_PAGES_UNLIMITED",
  "DYNAMIC_GROUPS": "tiers.featureNames.DYNAMIC_GROUPS",
  "SITE_TRACKING": "tiers.featureNames.SITE_TRACKING",
  "API_ACCESS": "tiers.features.API_ACCESS",
  "EMAIL_AUTORESPONDER": "tiers.features.EMAIL_AUTORESPONDER",
  "ADVANCED_AB_TESTING": "tiers.features.ADVANCED_AB_TESTING",
  "FILE_ATTACHMENT": "tiers.features.FILE_ATTACHMENT",
  "PURCHASE_TRIGGER": "tiers.features.PURCHASE_TRIGGER",
  "CART_ABANDONMENT": "tiers.features.CART_ABANDONMENT",
  "LANDING_PAGE_TRIGGER": "tiers.features.LANDING_PAGE_TRIGGER",
  "REVENUE_TRACKING": "tiers.features.REVENUE_TRACKING",
  "SUBACCOUNTS": "tiers.features.SUBACCOUNTS",
  "USER_PERMISSIONS": "tiers.features.USER_PERMISSIONS",
  "SMART_SEGMENTATION": "tiers.features.SMART_SEGMENTATION",
  "MESSAGE_TRIGGERS": "tiers.features.MESSAGE_TRIGGERS",
  "COUPON_MANAGEMENT": "tiers.features.COUPON_MANAGEMENT",
  "WEBHOOKS": "tiers.features.WEBHOOKS",
  "DYNAMIC_PRODUCTS": "tiers.features.DYNAMIC_PRODUCTS",
  "CATALOG_INTEGRATION": "tiers.features.CATALOG_INTEGRATION",
  "AMP_EMAIL": "tiers.features.AMP_EMAIL",
  "CHATBOT": "tiers.features.CHATBOT",
  "SURVEY_SYSTEM": "tiers.features.SURVEY_SYSTEM",
  "PHONE_SUPPORT": "tiers.features.PHONE_SUPPORT",
  "ACCOUNT_MANAGER": "tiers.features.ACCOUNT_MANAGER",
  "SMS_DYNAMIC_PRODUCTS": "tiers.features.SMS_DYNAMIC_PRODUCTS",
  "SEND_WEBHOOK_AUTOMATION": "tiers.features.SEND_WEBHOOK_AUTOMATION",
  "AI_PRODUCT_RECOMMENDATIONS": "tiers.features.AI_PRODUCT_RECOMMENDATIONS",
  "HIGH_VOLUME_SENDING": "tiers.features.HIGH_VOLUME_SENDING",
  "CUSTOM_DEVELOPMENT": "tiers.features.CUSTOM_DEVELOPMENT",
  "DEDICATED_ACCOUNT_MANAGER": "tiers.features.DEDICATED_ACCOUNT_MANAGER",
  "PRIORITY_SUPPORT": "tiers.features.PRIORITY_SUPPORT",
  "TRAINING_SESSIONS": "tiers.features.TRAINING_SESSIONS",
  "AI_AUTOMATION_BUILDER": "tiers.features.AI_AUTOMATION_BUILDER",
  "AI_EMAIL_DESIGNER": "tiers.features.AI_EMAIL_DESIGNER",
  "OPEN_IMAGE_SENDING": "tiers.features.OPEN_IMAGE_SENDING",
  "OTP_SMS": "tiers.features.OTP_SMS",
  "AI_COPYWRITER": "tiers.features.AI_COPYWRITER",
  "MMS_MESSAGING": "tiers.features.MMS_MESSAGING",
  "VOICE_CONVERSION": "tiers.features.VOICE_CONVERSION",
  "FLASH_SMS": "tiers.features.FLASH_SMS",
  "MAIL2SMS": "tiers.features.MAIL2SMS",
  "AI_LANDING_PAGE_DESIGNER": "tiers.features.AI_LANDING_PAGE_DESIGNER",
  "RCS_MESSAGING": "tiers.features.RCS_MESSAGING"
}