...
export const getSettingsItem=(t,style='', isAdmin) => ({
  title: <img
    alt='settings'
    src={SettingsLogo}
    className={style}
  ...
  options: [
    ...
    {title: t('master.RadMenuItemResource3.Text'),href: '/Pulseem/AccountUsers.aspx?fromreact=true',iconSrc: GroupMenuIcon, isShow: isAdmin },
    {title: t('master.RadMenuItemResource4.Text'),href: '/Pulseem/AccountUsersReport.aspx?fromreact=true',iconSrc: GrafMenuIcon, isShow: isAdmin},
