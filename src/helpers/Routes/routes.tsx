  ...
  return [
    ...
    },
    {
      ...
      options: [
        ...
        { key: 'directSendReport', title: t('report.DirectSendReport'), href: `${sitePrefix}Reports/DirectSendReport`, isShow: (isBeeperAccount || (accountSettings && accountSettings?.IsDirectAccount === true)) && !userRoles?.HideRecipients },
        { key: 'directSendReportArchive', title: t('report.ArchiveDirectSendReport'), href: `${sitePrefix}Reports/DirectSendReport/Archive`, isShow: (isBeeperAccount || (accountSettings && accountSettings?.IsDirectAccount === true)) && !userRoles?.HideRecipients },
