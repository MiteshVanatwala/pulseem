...
import { allMessages, attachButtons, dates, user } from './data';
				...
				<div className='chat__body'>
					...
					<header className='header chat__header'>
						<div className='chat__avatar-wrapper'>
							<img src={profile} width='40px' alt={'name'} className='avatar' />
						</div>
												...
												<>
													{message.image ? (
														<div
															...
															ref={assignRef()}>
															<img src={profile} alt='' className='chat__img' />
