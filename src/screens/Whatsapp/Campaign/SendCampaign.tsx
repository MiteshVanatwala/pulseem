...
const SendCampaign = ({
  ...
  const [sendType2Dialog, setsendType2Dialog] = useState<boolean>(false);
  ...
  //             {translator("mainReport.fieldInvalid")}:
  //           </span>
  //         </div>
  //         <div>
  //           <ul className={classes.fieldsRequire}>
  //             <li>
  //               {translator("sms.selectSendingType")} -{" "}
  ...
  //             )}
  //           >
  //             {translator("mainReport.confirmSms")}
  //           </Button>
  //         </div>
  //       </BaseDialog>
  //     </>
