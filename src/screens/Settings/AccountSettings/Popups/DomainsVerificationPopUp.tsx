                ...
                <Box style={{ position: 'relative', height: 'calc(100% - 80px)', display: 'flex', flexDirection: 'column' }}>
                    <Box style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }} className={classes.pb15}>
                        ...
                        <Link
                            ...
                            href="https://site.pulseem.co.il/%D7%9E%D7%93%D7%A8%D7%9B%D7%99%D7%9D/%d7%94%d7%a1%d7%91%d7%a8-%d7%9c%d7%94%d7%95%d7%a1%d7%a4%d7%aa-%d7%a8%d7%a9%d7%95%d7%9e%d7%95%d7%aa-%d7%93%d7%95%d7%9e%d7%99%d7%99%d7%9f/">
