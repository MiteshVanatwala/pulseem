...
const Temp_NLSS = ({ classes, ...props }) => {
    ...
    const handlePreviousPage = () => {
        window.location = `/react/newsletter/edit/${params.id}`;
    }
