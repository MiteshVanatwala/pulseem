...
import {
  Grid, Typography, Box, Button, CircularProgress,
    ...
    >
      <Box display="flex" justifyContent="space-between" alignItems="flex-start" mb={1.5}>
        <Box display="flex" alignItems="center">
          <Box
            width={40} height={40} borderRadius={10} bgcolor="#fff1ec"
    ...
    >
      <Box display="flex" justifyContent="space-between" alignItems="flex-start" mb={4} mt={2}>
        ...
        <Button
          ...
          disableElevation
          startIcon={<AddIcon />}
          style={{ backgroundColor: ACCENT, color: '#fff', textTransform: 'none', fontWeight: 600, borderRadius: 8, padding: '8px 20px' }}
      ...
      <Dialog open={createOpen} onClose={() => setCreateOpen(false)} maxWidth="xs" fullWidth>
        <DialogTitle>{t('common.widget_create_new', 'Create Widget')}</DialogTitle>
        <DialogContent>
        ...
        <DialogActions>
          <Button onClick={() => setCreateOpen(false)} style={{ textTransform: 'none' }}>
