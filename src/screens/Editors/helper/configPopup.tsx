...
export const PopupBeeConfig = (Options: ConfigOptions) => {
  const {
    moduleType,
    classes,
    onSaveUserBlock,
  ...
  return {
    ...
    editorFonts: FONTS(true),
    workspace: {
      type: 'popup', // Set to popup for popup builder
      popup: {
        layout: 'classic-center', // Default popup layout
        theme: 'custom', // Custom theme
        contentWidth: 600, // Content width
        contentWidthMobile: 300, // Mobile content width
        backgroundImage: '', // Optional background image
        backgroundImageMobile: '' // Optional mobile background image
      }
    },
    defaultModulesOrder: [
      'Form',
...
export const DefaultPopupContent = (IsRTL: Boolean, languageCode: number) => {
  const isRTLdirection: boolean = languageCode === 0 || languageCode === 8;
  ...
  return {
    ...
    defaultTemplate: {
      page: {
        ...
        description: "Default popup template for BEE",
        template: {
          name: "popup-template",
          type: "popup",
          version: "0.0.1",
