...
export const initClientForm = (extraFields, t, isRTL) => {
    return new Promise((resolve, reject) => {
        try {
            const clientForm = {
                Email: new BeeFormModel(ElementTypes.email, t('common.email'), true, false, { dir: isRTL ? 'rtl' : 'ltr', }),
                ...
                PulseemSurvey1: new BeeFormModel(ElementTypes.date, t('landingPages.surveyQuestion'), true, true, { dir: isRTL ? 'rtl' : 'ltr' })
            }
